namespace NotasPrefeituraSP.Models.Sp.Sync.Nfes
{
    ...
    public partial class PedidoConsultaNFe
    {

        private PedidoConsultaNFeCabecalho cabecalhoField;

        private PedidoConsultaNFeDetalhe[] detalheField;

        private SignatureType signatureField;

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(Form = System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public PedidoConsultaNFeCabecalho Cabecalho
        {
            get
            {
        ...
        public PedidoConsultaNFeDetalhe[] Detalhe
        {
            get
            {
